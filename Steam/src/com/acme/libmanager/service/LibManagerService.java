...
public class LibManagerService {
    ...
    public Map<String, Double> titleLegacy() {
...
//        }
    ...
    public void init() {
        bookList.add(new Book("Learning Java", new Author("Chetan", "chetain@gmail.com"),
                "programming", 39.99, Arrays.asList("Java", "Spring")));

        bookList.add(new Book("Learning Python", new Author("Chetan", "chetain@gmail.com"),
                "programming", 19.99, Arrays.asList("Python", "AI")));
